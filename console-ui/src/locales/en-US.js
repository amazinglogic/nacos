...
const I18N_CONF = {
  ...
  MainLayout: {
    ...
    dubboApplication: 'Dubbo Application List',
    dubboServiceCount: 'Dubbo Service Count',
  ...
  DubboApplication: {
    applicationList: 'Dubbo Application List',
    ...
    consumer: 'Consumers Count',
    apiVersion: 'Grayscale Version',
    online: 'online',
    offline: 'offline',
    operation: 'operation',
    applicationCount: 'Application Count',
    serviceTotal: 'Service Total',
    unhealthyName: 'Service Name',
    unhealthyGroup: 'Group',
    unhealthyLastBeat: 'Last Beat',
    unhealthyEnabled: 'Enabled',
    title: 'Unhealthy Service',
    healthyCount: 'Healthy Count',
  },
  DubboServiceCount: {
    serviceList: 'Dubbo Service Statistic',
    applicationName: 'Application Name',
    applicationNamePlaceholder: 'Enter Application Name',
    query: 'Search',
    pubNoData: 'No results found.',
